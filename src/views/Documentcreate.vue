  ...
  <v-container>
    <v-card class="mx-auto" outlined>
      <v-form @submit.prevent="submit" style="font-family: Phetsarath ot">
        ...
        <v-text-field v-model="customer.name" label="ທີ່ຢູ່" required></v-text-field>
        <v-text-field v-model="customer.address" label="ເລກທີຮັບອໍເດີ" required></v-text-field>
        <v-text-field
          v-model="customer.contact"
          label="ຜູ້ທີສາມາດຕິດຕໍ່ໄດ້"
          required
        ></v-text-field>
        <v-text-field v-model="customer.service" label="ລະຫັດຂົນສົ່ງ" required></v-text-field>
        <v-menu
          v-model="menu2"
        ...
        <v-text-field
          ...
          required
        ></v-text-field>
        <v-select :items="items" label="ຂະໜາດລົດ" dense></v-select>
        <v-text-field
        ...
        ></v-text-field>
           <v-text-field
          v-model="customer.employeename1"
          label="ເບີໂທ"
          required
        ></v-text-field>
         <v-text-field
          v-model="customer.employeename2"
          label="ສະຖານທີບໍລິການນ້ຳມັນ"
          required
        ></v-text-field>
         <v-text-field
          v-model="customer.employeename3"
          label="ລາຄາລວມ"
          required
        ></v-text-field>
        <br />
